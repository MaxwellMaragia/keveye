        ...
        <div class="footer_content">
            <div class="row">
                ...
                <div class="col-lg-3 footer_col">
                    ...
                    <div class="footer_column_content">
                        <ul>
                            <li class="footer_list_item"><a href="student_result.php">View results</a></li>
                            <li class="footer_list_item"><a href="changepassword.php">Change password</a></li>
                            <li class="footer_list_item"><a href="student_logout.php">Logout</a></li>
