...
<div id="page-wrapper">
    ...
    <div id="page-inner">
        ...
        <?php
                ...
                $sql = "SELECT * FROM results WHERE form='$form' AND period='$period' AND subject='$subject' ORDER BY total DESC";
                ...
                if(mysqli_num_rows($execute)>0) {
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <?= $subject ?> Results for form <?= $form ?> in <?= $period ?>
                        </div>
                ...
                else
                {
                    ...
                    <div class="alert alert-danger">
                        Oops!! No results found for entered category <a href="results.php">Back</a>
                        <?php
