...
$pdf->SetX(26);
$pdf->Cell(15,12,'Cycle two Subject Percentage/Grades Analysis',0,1);
...
//fetch results
$qry = "SELECT * FROM cycle_two WHERE form='$form' AND period='$period' ORDER BY average DESC";
...
//get total students
$sql_class="SELECT * FROM cycle_two WHERE class='$cls' AND period='$period'";
...
//get class rank
$query = "SELECT admission, average FROM cycle_two WHERE class='$cls' AND period='$period' ORDER BY average DESC ";
