...
else
{
    if(!($_SESSION['view_results_term'] && $_SESSION['view_results_class'] && $_SESSION['view_results_subject']))
    {
        ...
        $sql="SELECT * FROM cycle_one WHERE period='$period'  AND form='$form' ORDER BY average DESC";
        ...
        if(mysqli_num_rows($execute)>0)
        {
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <a href="allcycle_oneAnalysis.php" target="_blank" style="float: right;"><span class="glyphicon glyphicon-download-alt"></span> BroadSheet</a>
                </div>
                            ...
                            <table class="table table-bordered table-striped" id="example">
                                ...
                                while($get_results = mysqli_fetch_assoc($execute))
                                {
                                    ...
                                    <tr>
                                        ...
                                        foreach($get_subjects as $row)
                                        {
                                            $subject = $get_results[$row['SubjectName']];
                                            $result="$subject";
                                            if($result==0)
                                            {
                                                echo "<td>-</td>";
