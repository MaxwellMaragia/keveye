...
<head>
    ...
    <title>CYCLE TWO INDIVIDUAL RESULTS</title>
    <!-- Bootstrap Styles-->
                ...
                if(mysqli_num_rows($execute))
                {
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            CYCLE TWO  <a class="btn btn-info" href="individualcycleone.php">CYCLE ONE</a>  <a class="btn btn-warning" href="individualresults.php">AVERAGE</a>
                        </div>
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        $query = "SELECT admission, average FROM cycle_two WHERE form='$form' AND period='$exam_period' ORDER BY average DESC";
                                                        $exe = mysqli_query($obj->con,$query);
                                                        $sql_total = "SELECT admission FROM cycle_two WHERE form='$form'";
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        $query = "SELECT admission, average FROM cycle_two WHERE class='$class' AND period='$exam_period' ORDER BY average DESC ";
                                                        $exe = mysqli_query($obj->con,$query);
                                                        $sql_total = "SELECT admission FROM cycle_two WHERE class='$class'";
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="result_slip_two.php" TARGET="_blank" class="btn btn-info"><span class="glyphicon glyphicon-print"></span> Print results slip</a>
