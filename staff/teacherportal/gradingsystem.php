...
if($_SESSION['account']){
    ...
    if(isset($_POST['submit']))
    {
        ...
        else
        {
            ...
            if($obj->fetch_records("grading_system",$where))
            {
            ...
            else
            {
                ...
                $get_grades=$obj->fetch_all_records("grading_system");
                ...
                else
                {
                    ...
                    if($obj->insert_record("grading_system",$data))
                    {
...
<!--        content-->
      ...
      ?>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    $get_grades=$object->fetch_all_records("grading_system");
                    foreach($get_grades as $row)
                    {
                        ?>
                        <tr>
