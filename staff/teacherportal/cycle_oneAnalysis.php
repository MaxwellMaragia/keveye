...
$qry = "SELECT * FROM cycle_one WHERE class='$class' AND period='$period' ORDER BY average DESC";
...
while ($row = mysqli_fetch_array($run)) 
{
	...
	//get total students
$sql_class="SELECT * FROM cycle_one WHERE class='$class' AND period='$period'";
...
//get class rank
$query = "SELECT admission, average FROM cycle_one WHERE class='$class' AND period='$period' ORDER BY average DESC ";
