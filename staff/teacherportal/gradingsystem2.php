...
if($_SESSION['account']){
    ...
    if(isset($_POST['submit']))
    {
        ...
        else
        {
            ...
            if($obj->fetch_records("grading_system2",$where))
            {
            ...
            else
            {
                ...
                $get_grades=$obj->fetch_all_records("grading_system2");
                ...
                else
                {
                    ...
                    if($obj->insert_record("grading_system2",$data))
                    {
...
<head>
    ...
    <title>Form two grading system</title>
    <!-- Bootstrap Styles-->
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    $get_grades=$object->fetch_all_records("grading_system2");
                    foreach($get_grades as $row)
                    {
                        ?>
                        <tr>
