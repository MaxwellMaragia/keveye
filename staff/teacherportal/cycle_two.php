...
else
{
    if(!($_SESSION['view_results_term'] && $_SESSION['view_results_class'] && $_SESSION['view_results_subject']))
    {
        ...
        $sql="SELECT * FROM cycle_two WHERE period='$period'  AND class='$class' ORDER BY average DESC";
        ...
        if(mysqli_num_rows($execute)>0)
        {
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    Form <?=$class?> cycle two results for <?=$period?>
                    <a href="cycle_twoAnalysis.php" target="_blank" style="float: right;"><span class="glyphicon glyphicon-download-alt"></span> BroadSheet</a>
                </div>
                <div class="panel-body">

                    <div class="table-responsive">
                        <form action="<?php echo htmlentities($_SERVER['PHP_SELF'])?>" method="post">
                            <button name="download" type="submit" class="btn btn-primary" style="margin-bottom: 10px;"><span class="glyphicon glyphicon-download-alt"></span> Download result slips</button>
