...
//get total students
$sql_class="SELECT * FROM cycle_one WHERE class='$result_class' AND period='$year_term'";
$sql_form="SELECT * FROM cycle_one WHERE form='$result_class[0]' AND period='$year_term'";
...
//get class rank
$query = "SELECT admission, average FROM cycle_one WHERE class='$result_class' AND period='$year_term' ORDER BY average DESC ";
...
//get form rank
$sql = "SELECT admission, average FROM cycle_one WHERE form='$result_class[0]' AND period='$year_term' ORDER BY average DESC ";
$execute = mysqli_query($obj->con,$sql);
...
$fetch_total=$obj->fetch_records("cycle_one",$where);
