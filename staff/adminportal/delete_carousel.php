 ...
 if(isset($_POST['delete']))
  {
    ...
    while($file = mysqli_fetch_array($result))
     {
        $unlink = unlink('../../carousel/'.$file['image']);
      }
        if($unlink)
         {
 ...
 <div id="page-wrapper">
  <div id="page-inner">
    ...
    <div class="panel panel-default">
	  ...
	  <div class="panel-heading">Delete Sliding photos to Add new
   <a href="carousel.php" style="float: right; margin-top: -8px; font-size: 16px;">Back</a>
    </div>
                            ...
                            foreach ($get_data as $row)
                             {
                            	...
                            	<tr>
                            		<td><?php echo $id?></td>
                                    <td><?php echo "<img class='img-thumbnail' src='../../carousel/$img'>"?></td>
                                     <td><?php echo $desc?></td>
