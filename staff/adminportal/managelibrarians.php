...
if($_SESSION['admin_login']){
    ...
    include "functions/managelibrarians.php";
        ...
        <div class="row">
            <div class="col-md-12 " style="margin-top:20px;">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">List of librarians</div>
                    <div class="panel-body">
                        <div class="form-inline alert alert-info">
                            <form method="post" action="<?php htmlspecialchars($_SERVER['PHP_SELF'])?>">
                                <input type="text" placeholder="librarian name " class="form-control square-border" name="names" value="<?=$names?>" required />
                                <input type="text" placeholder="librarian jobnumber" class="form-control square-border" name="jobnumber" required />
                                <button type="submit" class="btn btn-primary square-btn-adjust" name="addnew">Add librarian</button>
                            </form>
                        </div>
                        <?php
                        ...
                        <div>
                            <form method="post" action="<?php htmlspecialchars($_SERVER['PHP_SELF'])?>">
                                <table class="table  table-hover table-striped table-bordered" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <?php
                                    $where = array('account'=>'librarian');
                                    $get_librarian=$obj->fetch_records("staff_accounts",$where);
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel"><?php echo $names?> account</h4>
                    </div>
